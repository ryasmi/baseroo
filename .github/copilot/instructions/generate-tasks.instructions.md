...
8.  **Save Task List:** Save the generated document in the `/.github/copilot/specs/[feature-name]/` directory with the filename `tasks.md`, where `[feature-name]` matches the base name of the input (PRD) design file.
